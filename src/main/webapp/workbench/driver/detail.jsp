...
<body>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			<div style="width: 300px; color: gray;">司机姓名</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${d.dname}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">年龄</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${d.dage}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			<div style="width: 300px; color: gray;">电话</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${d.dphone}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">住址</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${d.daddress}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			<div style="width: 300px; color: gray;">身份证号</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${d.idNumber}</b></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			<div style="width: 300px; color: gray;">司机所属网点</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${d.dplace}</b></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			<div style="width: 300px; color: gray;">驾驶证号</div>
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 50px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${d.createBy}</b></div>
